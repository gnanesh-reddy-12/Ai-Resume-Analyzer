...
function UploadBox() {
  ...
  return (
    ...
    <div id="upload" className="px-6">

      <div className="max-w-6xl mx-auto rounded-[32px] border border-white/30 bg-white/20 backdrop-blur-2xl shadow-[0_8px_32px_rgba(31,38,135,0.15)] p-10">
