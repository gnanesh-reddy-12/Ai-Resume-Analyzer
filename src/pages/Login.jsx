      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "32px 20px" }}>
        ...
        >
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <h1 style={{ fontSize: "var(--text-xl)", marginBottom: 6 }}>Welcome back</h1>
            <p style={{ fontSize: "var(--text-sm)", color: "var(--text-3)", lineHeight: 1.5 }}>Sign in to your ResumeAI account</p>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                <label style={{ fontSize: "var(--text-xs)", fontWeight: 600, color: "var(--text-2)" }}>Password</label>
                <Link to="/forgot-password" style={{ fontSize: "var(--text-xs)", fontWeight: 500, color: "var(--text-2)", textDecoration: "none" }}>Forgot password?</Link>
              </div>
              <div style={{ position: "relative" }}>
                <input className="input-ek" type={showPassword ? "text" : "password"} placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} onKeyDown={e => e.key === "Enter" && handleSubmit()} style={{ paddingRight: 40 }} />
