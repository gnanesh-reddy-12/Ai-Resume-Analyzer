      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: "32px 20px" }}>
        ...
        >
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <p style={{ fontSize: 14, color: "var(--text-3)", lineHeight: 1.5 }}>Sign in to your ResumeAI account</p>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                ...
                <Link to="/forgot-password" style={{ fontSize: 13, fontWeight: 500, color: "var(--accent)", textDecoration: "none" }}>Forgot password?</Link>
              </div>
              <div style={{ position: "relative" }}>
                <input className="input" type={showPassword ? "text" : "password"} placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} onKeyDown={e => e.key === "Enter" && handleSubmit()} style={{ paddingRight: 40 }} />
