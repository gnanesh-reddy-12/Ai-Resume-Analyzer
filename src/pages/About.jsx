      ...
      <div style={{ flex: 1, padding: "40px 20px" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 32 }}>
            <div style={{ width: 48, height: 48, background: "var(--accent-soft)", color: "var(--accent)", border: "1px solid var(--accent-mid)", borderRadius: "var(--r-lg)", display: "flex", alignItems: "center", justifyContent: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 32, color: "var(--text-2)", lineHeight: 1.7, fontSize: 15 }}>
            <section>
              <h2 style={{ fontSize: "var(--text-lg)", fontWeight: 700, color: "var(--text-1)", marginBottom: 12, borderLeft: "3px solid var(--accent)", paddingLeft: 12 }}>Our Mission</h2>
            ...
            <section>
              <h2 style={{ fontSize: "var(--text-lg)", fontWeight: 700, color: "var(--text-1)", marginBottom: 12, borderLeft: "3px solid var(--accent)", paddingLeft: 12 }}>How Our Technology Works</h2>
              ...
              <ul style={{ paddingLeft: 24, marginTop: 12, display: "flex", flexDirection: "column", gap: 8 }}>
                <li><strong style={{ color: "var(--accent)" }}>Contextual Keyword Matching:</strong> We don't just look for exact words; we look for related skills and context to ensure your experience shines through.</li>
                <li><strong style={{ color: "var(--accent)" }}>Formatting Analysis:</strong> We identify red flags in your document structure that might cause legacy ATS systems to crash or misread your data.</li>
                <li><strong style={{ color: "var(--accent)" }}>Actionable Feedback:</strong> Instead of just giving you a low score, we provide exact, rewritten bullet-point suggestions to maximize your impact.</li>
              </ul>
            </section>

            <section>
              <h2 style={{ fontSize: "var(--text-lg)", fontWeight: 700, color: "var(--text-1)", marginBottom: 12, borderLeft: "3px solid var(--accent)", paddingLeft: 12 }}>Who We Are</h2>
