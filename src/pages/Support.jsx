    ...
    <div style={{ minHeight: "100vh", background: "var(--bg)", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ flex: 1, padding: "40px 20px" }}>
        ...
        >
          ...
          <div style={{ background: "var(--surface-2)", border: "1px solid var(--border)", borderRadius: "var(--r-md)", padding: "24px" }}>
            <p style={{ fontSize: 13, fontWeight: 700, color: "var(--text-3)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 8 }}>Email Us At</p>
            <a href="mailto:reddygnanesh1205@gmail.com" style={{ fontSize: 18, fontWeight: 600, color: "var(--accent)", textDecoration: "none" }}>
